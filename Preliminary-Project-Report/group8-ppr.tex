...
\begin{figure}
    ...
    \begin{subfigure}{0.6\textwidth}
        \centering
        \includegraphics[width=\linewidth]{Preliminary-Project-Report/SRResNet.png}
        \caption{Architecture of the SRResNet}
    \end{subfigure}
\end{figure}

\subsection{Architecture of the CNN}
...
\begin{figure}
    \centering
    \includegraphics{Preliminary-Project-Report/ResNet18 - 1.png}
    \caption{Architecture of the CNN}
    \label{fig:enter-label}
\end{figure}

It is observed that the SRResNet architecture performs better than the bicubic interpolation by a reasonable margin.
...
\begin{table}
    ...
    \begin{tabular}{|| c | c ||}
        ...
        SRResNet &  56\% \\
        \hline
        Bicubic Interpolation & 45\% \\
        \hline
    \end{tabular}
    
    \caption{Accuracy for each architecture}
    \label{tab:my_label}
    \end{center}
\end{table}
